...
const TYPE_CONFIG: Record<string, { color: string; borderColor: string; bgColor: string; glowColor: string; icon: any; label: string; priority: number; iconBg: string; pillBg: string }> = {
  ...
  punishment: { color: "text-red-400", borderColor: "border-l-red-500", bgColor: "from-red-950/50 to-red-950/15", glowColor: "shadow-red-600/20", icon: Gavel, label: "PUNISHMENT", priority: 7, iconBg: "bg-red-900/50", pillBg: "bg-red-500/25 text-red-400" },
  reward: { color: "text-[#d4a24e]", borderColor: "border-l-[#d4a24e]", bgColor: "from-[#451a03]/50 to-[#451a03]/15", glowColor: "shadow-[#d4a24e]/20", icon: Gift, label: "REWARD", priority: 8, iconBg: "bg-[#451a03]/50", pillBg: "bg-[#d4a24e]/25 text-[#d4a24e]" },
...
const FILTER_OPTIONS = [
  ...
  { key: "scenes", label: "Scenes", icon: Play, types: ["play_session", "wager", "countdown_event", "dare"] },
  { key: "connection", label: "Connection", icon: Heart, types: ["devotion", "secret", "conflict", "rating", "achievement", "sticker_received"] },
...
const WINDOW_CONFIG_BASE = [
  ...
  { key: "scenes", label: "SCENES", icon: Play, types: ["play_session", "wager", "countdown_event", "dare"], defaultSize: "wide" as WindowSize, borderColor: "#e87640", glowColor: "rgba(232,118,64,0.2)", bgFrom: "rgba(67,20,7,0.35)", headerBg: "rgba(232,118,64,0.08)" },
  ...
  { key: "connection", label: "CONNECTION", icon: Heart, types: ["devotion", "secret", "conflict", "rating", "achievement", "sticker_received"], defaultSize: "standard" as WindowSize, borderColor: "#b87333", glowColor: "rgba(184,115,51,0.2)", bgFrom: "rgba(69,26,3,0.3)", headerBg: "rgba(184,115,51,0.08)" },
